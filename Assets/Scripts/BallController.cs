...
public class BallController : MonoBehaviour
{
    ...
    [SerializeField]
    List<int> _SaveBall = new List<int>();
   ...
   float _FollowSpeed ;
    ...
    {
        if (!_Player.GetComponent<PlayerController>().GetStop())
        {
            _TempSpeed = _FollowSpeed + (10  * _Player.GetComponent<PlayerController>().GetJoystickValue());
        ...
        else
        {
            ...
            Mathf.Lerp(_Balls[0].GetComponent<Rigidbody>().position.x, _Root.GetComponent<Rigidbody>().position.x, .5f),
            Mathf.Lerp(_Balls[0].GetComponent<Rigidbody>().position.y, _Root.GetComponent<Rigidbody>().position.y, .2f),
            Mathf.Lerp(_Balls[0].GetComponent<Rigidbody>().position.z, _Root.GetComponent<Rigidbody>().position.z, .2f)
            ...
            _Balls[0].GetComponent<Rigidbody>().rotation = Quaternion.Lerp(_Balls[0].GetComponent<Rigidbody>().rotation, _Root.GetComponent<Rigidbody>().rotation, .2f);
